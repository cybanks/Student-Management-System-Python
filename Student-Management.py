...
class StudentManagementSystem:
    def __init__(self, root):
        ...
        # Labels
        self.label_title = tk.Label(root, text="Student Management System", font=("Arial", 16, "bold"),
                                    fg=self.text_color, bg="#1e1e1e")
        self.label_title.pack(pady=10)

        self.label_name = tk.Label(root, text="Student Name:", fg=self.text_color, bg="#1e1e1e")
        self.label_name.pack()

        self.entry_name = tk.Entry(root, bg="#333", fg="white", insertbackground="white")
        self.entry_name.pack(pady=2)

        self.label_age = tk.Label(root, text="Age:", fg=self.text_color, bg="#1e1e1e")
        self.label_age.pack()

        self.entry_age = tk.Entry(root, bg="#333", fg="white", insertbackground="white")
        ...
        self.button_exit = tk.Button(root, text="Exit", command=root.quit,
                                     bg="#ff5555", fg="white", activebackground="#cc4444", activeforeground="white",
                                     relief="raised", borderwidth=2)
